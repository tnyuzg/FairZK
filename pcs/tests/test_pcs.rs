use algebra::{
    utils::Transcript, BabyBear, BabyBearExtension, DenseMultilinearExtension, FieldUniformSampler,
...
fn pcs_test() {
    ...
    let code_spec = ExpanderCodeSpec::new(0.1195, 0.0284, 2.0, BASE_FIELD_BITS, 10);
    ...
    let ext_poly = DenseMultilinearExtension::from_vec(num_vars, evaluations);
