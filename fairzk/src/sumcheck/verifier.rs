...
use super::{prover::ProverMsg, Error, IPForMLSumcheck};
...
#[derive(Default)]
pub struct SumcheckOracle<F: Field> {
...
impl<F: Field> IPForMLSumcheck<F> {
    ...
    pub fn check_and_generate_subclaim(
        ...
        Ok(SumcheckOracle {
            sumcheck_point: verifier_state.randomness,
            oracle_eval: expected,
        })
    }
